...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { duration: @station.duration, program_id: @station.program_id, sequence: @station.sequence }
    end
  ...
  test "should update station" do
    patch :update, id: @station, station: { duration: @station.duration, program_id: @station.program_id, sequence: @station.sequence }
    assert_redirected_to station_path(assigns(:station))
  end
