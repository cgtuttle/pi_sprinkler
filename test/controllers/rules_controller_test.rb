...
class RulesControllerTest < ActionController::TestCase
  ...
  test "should create rule" do
    assert_difference('Rule.count') do
      post :create, rule: { exclusive: @rule.exclusive, group: @rule.group, name: @rule.name }
    end
  ...
  test "should update rule" do
    patch :update, id: @rule, rule: { exclusive: @rule.exclusive, group: @rule.group, name: @rule.name }
